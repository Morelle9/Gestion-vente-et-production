...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblclient WHERE Email=:email and Cellphnumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblclient set Password=:newpassword where Email=:email and Cellphnumber=:mobile";
...
<html>
<head>
	<title>Gestion COMPAFRIQUE||Forgot Password Page</title>
...
<body>
	<div class="error_page">
		...
		<div class="error-top">
			<h2 class="inner-tittle page">Compafrique Clients</h2>
			<div class="login">
				...
				<form id="login" method="post" name="chngpwd" onSubmit="return valid();"> 
					...
					<div class="new">
						<p><a href="indexClient.php">Already have an account</a></p>
						<div class="clearfix"></div>
					</div>
				</form>
			</div>
