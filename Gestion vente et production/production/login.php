...
<head>
        <title>Systeme de GESTION DE LA PRODUCTION|| Login Page</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post">
				 <div class="control-group normal_text"> <h3>SYSTEME</strong> <strong style="color: orange">GESTION DE COMPAFRIQUE</strong></h3></div>
            ...
            <div style="padding-left: 180px;">
                    <a href="../production/index.php" class="flip-link btn btn-info" id="to-recover"><i class="icon-home"></i>  Back to Home</a>
