...
?>
        ...
        <li class="bg_lo span3"> <a href="manage_user.php"> <i class="icon-user"></i>
...
$tseven+=$sevendays_sale;
 ...
 ?>
                <li class="bg_lh"><font style="font-size:22px; font-weight:bold">FCFA</font> <strong><?php echo number_format($tseven,2);?></strong> <small>Ventes Semaines </small></li>
            <?php
//Total Sale
...
<li class="bg_lh"><font style="font-size:22px; font-weight:bold">FCFA</font> <strong><?php echo number_format($totalsale,2);?></strong> <small>Total Ventes</small></li>
